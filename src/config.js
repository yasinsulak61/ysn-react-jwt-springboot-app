export default {
    defaultPath: '/restapp/dashboard/default',
    basename: '/restapp', // only at build time to set, like /datta-able
    ...
    navListIcon: 'style', // style1, (style2, style3, style4, style5, style6 are not available in lite version)
